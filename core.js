...
const dataPetugas = {
  ...
  "Kompi B": ["Didi R, S.IP./ASN","Eko S, S.H./ASN","Doni S, S.E./ASN","Andriansyah, S.M./ASN","Aziz N, S.H./ASN","Arip R.H/ASN","Bambang/ASN","Wahyu N/ASN","Adam Suryana/CPNS","Agge N/CPNS","Braja M/CPNS","Adnan S/PJLP","Amri A.R/PJLP","M. Fadli/PJLP","M. Rastu R/PJLP","Sigit R/PJLP","Chaerul B/PJLP","Ivan F/PJLP","M. Sholahudin/PJLP"],
  "Kompi C": ["Eko Prasetyo, S.H./ASN","Feri Hamdanika, SH/ASN","Muhamad Dikky Purnama/ASN","Ade Fadillah/ASN","Bayu Hario Santoso, S.Kom./ASN","Endang Hidayat/ASN","Agus Suliyanto, SE/ASN","Novie Andri W/ASN","Septian/ASN","Geza Ravi Rizky Lutviagusta/CPNS","Sultan Mahesa/CPNS","Agung/PJLP","Andi Kurniawan/PJLP","Burhanudin/PJLP","Endang Nurcahya/PJLP","Frido Amirulloh/PJLP","Sahrul Gunawan/PJLP","Sukron Khairil F./PJLP","Andri Juliansyah/PJLP","M. Tegar Maulana G./PJLP","Adhiya Rizqi Amarullah/PJLP","Rohman/PJLP","Faiz Eka A/PJLP","Tauchid M/PJLP"]
};
